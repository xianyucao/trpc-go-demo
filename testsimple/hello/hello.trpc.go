...
type HelloWorldService interface {
	Hello(ctx context.Context, req *HelloRequest) (*HelloResponse, error) // @alias=/demo/sayHello
}
...
type HelloWorldClientProxy interface {
	Hello(ctx context.Context, req *HelloRequest, opts ...client.Option) (rsp *HelloResponse, err error) // @alias=/demo/sayHello
}
...
func (c *HelloWorldClientProxyImpl) Hello(ctx context.Context, req *HelloRequest, opts ...client.Option) (*HelloResponse, error) {
	...
	msg.WithClientRPCName("/hello.HelloWorld/Hello")
