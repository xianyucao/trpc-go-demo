...
type HelloWorldService interface {
	...
	Hello(ctx context.Context, req *HelloRequest) (*HelloResponse, error) // @alias=/demo/Searching
}
...
type HelloWorldClientProxy interface {
	// Hello Hello says hello.
	Hello(ctx context.Context, req *HelloRequest, opts ...client.Option) (rsp *HelloResponse, err error) // @alias=/demo/Searching
}
